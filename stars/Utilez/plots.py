...
# Idea tomada de: https://stackoverflow.com/questions/70003173/how-to-plot-a-hollow-circle-with-gradient-fadeout-glow-in-matplotlib
def circlef(ax, xy0, func, rad, inrad=0,
            ...
            location='left', aspect=20, fraction=0.047, zorder=3):
    """
